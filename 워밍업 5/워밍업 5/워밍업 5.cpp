//화면에30x30크기의보드를그린다(30x30의각 칸에.을 찍어보드를표현한다). 사용자에게사각형의두개의좌
//표값(x1, y1) (x2, y2) 값을 입력 받는다.
//• 총2개의도형을그리고, 명령어에따라도형을이동, 확대 / 축소, 한좌표측으로의확대 / 축소하여그리고두도형
//의충돌도체크한다.
//• 도형을이동하다가두도형이겹쳐지게되면그부분을다른색으로표시한다.
//• 보드크기변경가능
#include<iostream>
#include<vector>
#include <windows.h>
